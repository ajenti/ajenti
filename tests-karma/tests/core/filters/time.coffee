describe 'time filter', () ->
    it 'works', () ->
        inject (timeFilter) ->
            ...
            expect(timeFilter(3661+3600*24)).to.equal('1:01:01:01')
            expect(timeFilter(3661+3600*24*99)).to.equal('99:01:01:01')
            expect(timeFilter(59+59*60+3600*23+3600*24*99)).to.equal('99:23:59:59')
